//	This file was generated by St4mpede 2015-12-15 21:14:44Z.
...
public partial class User
{
	...
	/// <summary> This is the GetHasCode method.
	/// </summary>
	public override System.Int32 GetHashCode()
	{
		int hash = 13;
		hash = (hash*7) + /*check for null*/ this.UserId.GetHashCode();
		hash = (hash*7) + /*check for null*/ this.UserName.GetHashCode();
		hash = (hash*7) + /*check for null*/ this.HashedPassword.GetHashCode();
		hash = (hash*7) + /*check for null*/ this.LastLoggedOnDatetime.GetHashCode();
		return hash;
	}
}
