...
namespace TheDal.Surface
{
	...
	public class ProjectSurface
	{
		...
		/// <summary> This method is used for adding a new record in the database.
		/// </summary>
		private TheDAL.Poco.Project Add( TheDAL.Poco.Project project )
		{
			//TODO:OF:TBA.
			return null;
		}
		...
		/// </summary>
		public void Delete( TheDAL.Poco.Project project )
		{
		...
		/// </summary>
		public void DeleteById( System.Int32 projectId )
		{
			//TODO:OF:TBA. =>get or throw exception.
		}
		...
		/// </summary>
		public IList<TheDAL.Poco.Project> GetAll()
		{
			//TODO:OF:TBA.
			return null;
		}
		...
		/// </summary>
		public TheDAL.Poco.Project GetById( System.Int32 projectId )
		{
			//TODO:OF:TBA. =>get or throw exception.
			return null;
		}
		...
		/// </summary>
		public TheDAL.Poco.Project LoadById( System.Int32 projectId )
		{
		...
		/// <summary> This method is used for updating an existing record in the database.
		/// </summary>
		private TheDAL.Poco.Project Update( TheDAL.Poco.Project project )
		{
			//TODO:OF:TBA.
			return null;
		}
		...
		/// If the primary key is 0 (zero) we know it is a new record and try to add it. Otherwise we try to update the record.
		/// </summary>
		public TheDAL.Poco.Project Upsert( TheDAL.Poco.Project project )
		{
			//TODO:OF:TBA. =>if( return 0 == primarykey ? Add(...) : Update(...)
			return null;
		}
